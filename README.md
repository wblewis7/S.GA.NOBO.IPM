...
The gzip datafile can be loaded into R using `load("S.GA.NOBO.IPM.data.gzip")`. 
It is a structured as a list with 43 object that are defined in the following. 
